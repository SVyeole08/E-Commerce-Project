        ...
        <div className="app-container flex items-center justify-between">
          <div className="flex items-center gap-4">
            <Link to="/" className="flex items-center gap-3">
              <Logo size={36} />
              <div className="text-2xl font-bold border-l pl-2 border-[#525D71] text-white">
                GrabIt
              </div>
            </Link>
            <div className="hidden md:flex items-center gap-6 text-sm text-muted">
              <NavLink
                to="/"
                className={({ isActive }) =>
                  isActive ? "text-[#3686F3]" : "text-white"
                }
              >
                Home
              </NavLink>
          ...
          <div className="flex items-center gap-4">
            {users ? (
              ...
              <NavLink
                to="/Login"
                className="btn px-4 py-2 rounded-md bg-gradient-to-r from-cyan-400 to-blue-500 text-black text-sm font-medium"
              >
                Login
              </NavLink>
            )}
            ...
            <button
              className="md:hidden px-3 py-2 bg-white/6 rounded-md"
              onClick={() => setOpen((v) => !v)}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
